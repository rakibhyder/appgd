...
#    sub_dim=128#512
    ...
    for subtype in subtype_pool: 
        ...
        test_alpha=3.84e-2*np.float(train_alpha)*test_batch_size/train_batch_size#200
...
#                z_test=z_test_temp
    ...
    #            plt.show()
        ...
        np.savez('/media/rakib/Data/Data/GLO/icassp2019/Results/'+train_dataset+'_'+test_z_type+'_'+str(z_dim)+z_norm_type+'_alpha'+str(test_alpha)+'_epochs'+str(test_epochs)+'_'+str(test_batch_size)+'phase_retrieval_init_'+x_init+'_eta_'+str(eta)+subtype+'_subsample_'+str(sub_dim),z_test=z_test,mask=mask,x_rec=x_rec,x_rec_org=x_rec_org)
